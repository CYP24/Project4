...
class categoryClass:
    ...
    def add(self):
        ...
        try:
            with self.get_connection() as con:
                cur = con.cursor()
                cur.execute("select * from category where name=?", (self.var_name.get().strip(),))
                row = cur.fetchone()
    ...
    def delete(self):
        ...
        try:
            with self.get_connection() as con:
                cur = con.cursor()
                cur.execute("select * from category where cid=?", (self.var_cat_id.get().strip(),))
                row = cur.fetchone()
                ...
                cur.execute("delete from category where cid=?", (self.var_cat_id.get().strip(),))
                con.commit()
